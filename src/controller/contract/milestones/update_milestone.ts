...
export const updateAProductMilestone = async (contractAddress: string, data: any) => {
 
  try {
   await swearITContract(contractAddress, true).setMilestoneCompleted(data["milestoneId"]);
