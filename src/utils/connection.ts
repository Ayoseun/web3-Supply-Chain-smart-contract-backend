...
export let factoryContract: any, txFactorySigner: any,signer:any, provider:any;
...
factoryContract = new ethers.Contract(COMMON_CONFIG.NETWORK_CONFIG.FACTORY_CONTRACT_ADDRESS, factoryABI, provider);

// Connecting the signer to the factory contract instance
txFactorySigner = factoryContract.connect(signer);

// Defining a function to create a new contract instance for a SwearIT contract
export const swearITContract = (address: string, w: boolean) => {
